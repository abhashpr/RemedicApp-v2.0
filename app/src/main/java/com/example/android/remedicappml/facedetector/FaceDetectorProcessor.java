...
import com.example.android.remedicappml.VisionProcessorBase;
import com.example.android.remedicappml.PreferenceUtils;
...
public class FaceDetectorProcessor extends VisionProcessorBase<List<Face>> {
    ...
    @Override
    protected Task<List<Face>> detectInImage(InputImage image) { return detector.process(image); }
